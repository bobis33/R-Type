...
namespace cli
{
    namespace SpriteRect
    {
        ...
        {
            const int fx = SpriteSheet::Asteroid::marginX +
                           col * (SpriteSheet::Asteroid::frameW + SpriteSheet::Asteroid::spacingX);
            const int fy = SpriteSheet::Asteroid::marginY +
                           row * (SpriteSheet::Asteroid::frameH + SpriteSheet::Asteroid::spacingY);
        ...
        {
            const int fx =
                SpriteSheet::Enemy::marginX + col * (SpriteSheet::Enemy::frameW + SpriteSheet::Enemy::spacingX);
            const int fy =
                SpriteSheet::Enemy::marginY + row * (SpriteSheet::Enemy::frameH + SpriteSheet::Enemy::spacingY);
