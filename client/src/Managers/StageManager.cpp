...
void cli::StageManager::update(ecs::Registry &registry, float dt, const eng::WindowSize &size)
{
    m_stageTimer += dt;
...
void cli::StageManager::spawnStage(ecs::Registry &registry, int screenWidth)
{
