...
namespace cli
{
    static char keyToChar(eng::Key key, bool shift = false)
    {
        switch (key)
        {
            case eng::Key::Q: return shift ? 'A' : 'a';
            case eng::Key::W: return shift ? 'Z' : 'z';
            case eng::Key::E: return shift ? 'E' : 'e';
            case eng::Key::R: return shift ? 'R' : 'r';
            case eng::Key::T: return shift ? 'T' : 't';
            case eng::Key::Y: return shift ? 'Y' : 'y';
            case eng::Key::U: return shift ? 'U' : 'u';
            case eng::Key::I: return shift ? 'I' : 'i';
            case eng::Key::O: return shift ? 'O' : 'o';
            case eng::Key::P: return shift ? 'P' : 'p';
            
            case eng::Key::A: return shift ? 'Q' : 'q';
            case eng::Key::S: return shift ? 'S' : 's';
            case eng::Key::D: return shift ? 'D' : 'd';
            case eng::Key::F: return shift ? 'F' : 'f';
            case eng::Key::G: return shift ? 'G' : 'g';
            ...
            case eng::Key::C: return shift ? 'C' : 'c';
            case eng::Key::V: return shift ? 'V' : 'v';
            case eng::Key::B: return shift ? 'B' : 'b';
            case eng::Key::N: return shift ? 'N' : 'n';

            case eng::Key::Num0: return '0';
            case eng::Key::Num1: return '1';
            case eng::Key::Num2: return '2';
            case eng::Key::Num3: return '3';
            case eng::Key::Num4: return '4';
            case eng::Key::Num5: return '5';
            case eng::Key::Num6: return '6';
            case eng::Key::Num7: return '7';
