...
#include "RTypeGame/GameConfig.hpp"
#include "ECS/Component.hpp"
#include "Interfaces/IAudio.hpp"

gme::GameSolo::GameSolo(const std::shared_ptr<eng::IRenderer> &renderer, const std::shared_ptr<eng::IAudio> &audio)
    : m_audio(audio)
{
    ...
    registry.createEntity().with<ecs::Audio>("id_audio", gme::Path::Audio::AUDIO_TITLE, 5.F, true, true).build();
    registry.createEntity()
        .with<ecs::Font>("main_font", gme::Path::Font::FONTS_RTYPE)
        .with<ecs::Transform>("transform_title", 10.F, 10.F, 0.F)
        .with<ecs::Color>("color_title", gme::Color::WHITE.r, gme::Color::WHITE.g, gme::Color::WHITE.b, gme::Color::WHITE.a)
    ...
    m_fpsEntity = registry.createEntity()
                      ...
                      .with<ecs::Color>("color_fps", gme::Color::WHITE.r, gme::Color::WHITE.g, gme::Color::WHITE.b, gme::Color::WHITE.a)
    ...
    m_enemyCounterEntity = registry.createEntity()
                               ...
                               .with<ecs::Color>("color_enemy_counter", gme::Color::WHITE.r, gme::Color::WHITE.g, gme::Color::WHITE.b, gme::Color::WHITE.a)
    ...
    m_asteroidCounterEntity = registry.createEntity()
                                  ...
                                  .with<ecs::Color>("color_asteroid_counter", gme::Color::WHITE.r, gme::Color::WHITE.g, gme::Color::WHITE.b, gme::Color::WHITE.a)
    ...
    m_playerEntity = registry.createEntity()
                         ...
                         .with<ecs::Rect>("player_rect", 0.F, 0.F, static_cast<int>(gme::GameConfig::Player::SPRITE_WIDTH),
                                          static_cast<int>(gme::GameConfig::Player::SPRITE_HEIGHT))
                         .with<ecs::Scale>("player_scale", gme::GameConfig::Player::SCALE, gme::GameConfig::Player::SCALE)
                         .with<ecs::Texture>("player_texture", gme::Path::Texture::TEXTURE_PLAYER)
                         .with<ecs::Player>("player", true)
                         .with<ecs::BeamCharge>("beam_charge", 0.0f, gme::GameConfig::Beam::MAX_CHARGE)
                         .with<ecs::Hitbox>("player_hitbox", gme::GameConfig::Hitbox::PLAYER_RADIUS)
                         .build();
    ...
    for (int i = 0; i < 50; ++i)
    {
        registry.createEntity()
            ...
            .with<ecs::Color>("star_far_color", gme::Color::WHITE_TRANS.r, gme::Color::WHITE_TRANS.g, gme::Color::WHITE_TRANS.b, gme::Color::WHITE_TRANS.a)
    ...
    for (int i = 0; i < 30; ++i)
    {
        registry.createEntity()
            ...
            .with<ecs::Transform>("star_mid_transform", static_cast<float>(std::rand() % screenWidth),
                                  static_cast<float>(std::rand() % screenHeight), 0.0f)
            .with<ecs::Color>("star_mid_color", gme::Color::BLUE.r, gme::Color::BLUE.g, gme::Color::BLUE.b, gme::Color::BLUE.a)
    ...
    for (int i = 0; i < 20; ++i)
    {
        registry.createEntity()
            ...
            .with<ecs::Transform>("star_near_transform", static_cast<float>(std::rand() % screenWidth),
                                  static_cast<float>(std::rand() % screenHeight), 0.0f)
            .with<ecs::Color>("star_near_color", gme::Color::YELLOW.r, gme::Color::YELLOW.g, gme::Color::YELLOW.b, gme::Color::YELLOW.a)
    ...
    for (int i = 0; i < 10; ++i)
    {
        registry.createEntity()
            ...
            .with<ecs::Transform>("star_shooting_transform", static_cast<float>(std::rand() % screenWidth),
                                  static_cast<float>(std::rand() % screenHeight), 0.0f)
            .with<ecs::Color>("star_shooting_color", gme::Color::GREEN.r, gme::Color::GREEN.g, gme::Color::GREEN.b, gme::Color::GREEN.a)
    ...
    for (int i = 0; i < 5; ++i)
    {
        registry.createEntity()
            ...
            .with<ecs::Transform>("planet_far_transform", static_cast<float>(std::rand() % screenWidth),
                                  static_cast<float>(std::rand() % screenHeight), 0.0f)
            .with<ecs::Color>("planet_far_color", gme::Color::PURPLE.r, gme::Color::PURPLE.g, gme::Color::PURPLE.b, gme::Color::PURPLE.a)
    ...
    for (int i = 0; i < 3; ++i)
    {
        registry.createEntity()
            ...
            .with<ecs::Transform>("nebula_transform", static_cast<float>(std::rand() % screenWidth),
                                  static_cast<float>(std::rand() % screenHeight), 0.0f)
            .with<ecs::Color>("nebula_color", gme::Color::BLUE_SECOND.r, gme::Color::BLUE_SECOND.g, gme::Color::BLUE_SECOND.b, gme::Color::BLUE_SECOND.a)
    ...
    for (int i = 0; i < 8; ++i)
    {
        registry.createEntity()
            ...
            .with<ecs::Transform>("comet_transform", static_cast<float>(std::rand() % screenWidth),
                                  static_cast<float>(std::rand() % screenHeight), 0.0f)
            .with<ecs::Color>("comet_color", gme::Color::GREEN.r, gme::Color::GREEN.g, gme::Color::GREEN.b, gme::Color::GREEN.a)
...
void gme::GameSolo::update(const float dt, const eng::WindowSize &size)
{
    ...
    float speed = gme::GameConfig::Player::SPEED;
    float diagonal_speed = speed * gme::GameConfig::Player::DIAGONAL_SPEED_MULTIPLIER;
    ...
    playerTransform->x = std::min(playerTransform->x, static_cast<float>(size.width) -
                                                          gme::GameConfig::Player::SPRITE_WIDTH * gme::GameConfig::Player::SCALE);
    playerTransform->y =
        std::min(playerTransform->y,
                 static_cast<float>(size.height) - gme::GameConfig::Player::SPRITE_HEIGHT * gme::GameConfig::Player::SCALE);
}
