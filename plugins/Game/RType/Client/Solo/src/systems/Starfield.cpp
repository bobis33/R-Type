...
void gme::StarfieldSystem::createStarfield(ecs::Registry &registry, int screenWidth, int screenHeight)
{
...
void gme::StarfieldSystem::update(ecs::Registry &registry, float dt)
{
