...
ecs::Entity gme::PlayerController::createPlayer(ecs::Registry &registry, float x, float y)
{
...
void gme::PlayerController::handleInput(ecs::Registry &registry, const eng::Event &event)
{
    switch (event.type)
    {
...
void gme::PlayerController::update(ecs::Registry &registry, float dt)
{
