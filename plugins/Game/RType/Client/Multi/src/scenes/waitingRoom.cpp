...
namespace gme
{
    WaitingRoomScene::WaitingRoomScene(const eng::id assignedId, const std::shared_ptr<eng::IRenderer> &renderer)
    ...
    void WaitingRoomScene::setupEventSubscriptions() const
    {
    ...
    void WaitingRoomScene::handleGameStart(const utl::Event &event) const
    {
        try
        {
            rnp::Serializer deserializer(event.data);
    ...
    void WaitingRoomScene::leaveLobby() const
    {
