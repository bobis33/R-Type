...
gme::WaitingRoomScene::WaitingRoomScene(eng::id assignedId, const std::shared_ptr<eng::IRenderer> &renderer)
    : AScene(assignedId), m_renderer(renderer)
{
    ...
    m_startButtonEntity =
        registry.createEntity()
            ...
            .with<ecs::Color>("color_start", utl::Config::Color::GRAY_BLUE_SUBTLE.r,
                              utl::Config::Color::GRAY_BLUE_SUBTLE.g, utl::Config::Color::GRAY_BLUE_SUBTLE.b,
                              utl::Config::Color::GRAY_BLUE_SUBTLE.a)
...
void gme::WaitingRoomScene::update(float dt, const eng::WindowSize & /*size*/)
{
    processEventBus();
    ...
    if ((leaveColor != nullptr) && (readyColor != nullptr) && (leaveText != nullptr) && (readyText != nullptr))
    {
        ...
        if (m_isHost && (startColor != nullptr) && (startText != nullptr))
        {
            startColor->r = utl::Config::Color::GRAY_BLUE_SUBTLE.r;
            startColor->g = utl::Config::Color::GRAY_BLUE_SUBTLE.g;
            startColor->b = utl::Config::Color::GRAY_BLUE_SUBTLE.b;
        ...
        else if (m_selectedButton == BUTTON_START && m_isHost && (startColor != nullptr) && (startText != nullptr))
        {
            startColor->r = utl::Config::Color::CYAN_ELECTRIC.r;
            startColor->g = utl::Config::Color::CYAN_ELECTRIC.g;
            startColor->b = utl::Config::Color::CYAN_ELECTRIC.b;
            startText->content = "> Start Game";
        }
    }
    if (m_hasLobbyInfo)
...
void gme::WaitingRoomScene::updatePlayerDisplay()
{
    ...
    for (std::uint8_t i = 0; i < m_currentLobbyInfo.maxPlayers; ++i)
    {
        ...
        ecs::Entity playerEntity =
            registry.createEntity()
                .with<ecs::Font>("main_font", utl::Path::Font::FONTS_RTYPE)
                .with<ecs::Transform>("transform_player_" + std::to_string(i), 120.F, 320.0F + (i * 40.0F), 0.F)
